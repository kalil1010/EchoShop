  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          Mauris ac mauris sed pede pellentesque fermentum. Maecenas adipiscing ante non diam. Proin sed quam. Sed vitae nisi. Proin at urna. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Fusce est. In hac habitasse platea dictumst. Suspendisse vel gengs. Nam consectetuer. Sed commodo, magna quis lacinia ornare, quam ante aliquam nisi, eu iaculis leo purus venenatis dui.
        </p>
      </div>
    </div>
  );
