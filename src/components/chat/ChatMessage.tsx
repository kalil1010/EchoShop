...
export function ChatMessage({ type, content, caption, imageUrl, isUser, timestamp, imagePreviewUrl }: ChatMessageProps) {
  ...
  const assistantHtml = content ? addColorSwatches(renderBasicMarkdown(content)) : ''
      ...
      >
        ...
        {isUser ? (
          ...
          <div className="space-y-3">
            {showImage && imageUrl && (
              <img src={imageUrl} alt={altText} className="w-full max-h-96 rounded-lg object-cover" />
            )}
            {showCaption && caption && (
