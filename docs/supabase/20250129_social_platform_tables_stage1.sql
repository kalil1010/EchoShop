-- ------------------------------------------------------------------
-- Social Platform Database Schema - Stage 1: Tables, Functions, Triggers
-- ------------------------------------------------------------------
-- This is Stage 1 of a two-stage migration.
-- Stage 1: Creates all tables, indexes, functions, and triggers
-- Stage 2: Creates all RLS policies (run after Stage 1)
-- ------------------------------------------------------------------
-- Run this file first, then run 20250129_social_platform_tables_stage2.sql
-- ------------------------------------------------------------------
...
-- Enable RLS (policies will be created in Stage 2)
